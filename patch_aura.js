...
const targetStart = `    // 등급별 특수 아우라 그리기`;
const targetEnd = `    const drawImg = this.lineage === 'idealism' ? Player.spriteImagePlato : Player.spriteImageAristotle;`;
...
const replacement = `    // 8-Aura System Drawing (concentric, level-based scaling)
...
console.log("Aura successfully patched!");
