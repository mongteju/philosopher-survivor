...
export const AURA_DB = {
  ...
  thorns: {
    ...
    icon: '🌵',
    color: '#1dd1a1',
    desc: '가시 덩굴 오라를 전개하여 범위 내의 적들에게 중독 중첩(최대 10중첩)을 쌓고 지속 피해(DoT)를 입힙니다. 중독 피해량은 적의 최대 체력 비례 및 기본 플랫 데미지 중 높은 값으로 적용됩니다.',
    statsDesc: '범위 내 적에게 지속적인 중독 피해'
  },
  trueshot: {
    name: '트루샷 오라',
    icon: '🎯',
...
export const LINEAGE_AURA_SYNERGY = {
  ...
  taoism:       { aura: 'thorns',    name: '🌪️ 도가의 고유 오라', desc: '절대 회피율 lvl × 10% 증가 및 회피 시 회오리 소환 효과가 유지됩니다. 추가로 쏜즈 오라의 피해량이 2.5배 증폭되며, 범위 내의 적들을 서서히 끌어당기고 40% 둔화시킵니다.' },
  buddhism:     { aura: 'devotion',  name: '📿 불교의 고유 오라', desc: '초근접 스킬(금강막, 염주) 반경 극소화 및 초고속 회전(극딜), 강력한 흡입 효과(적을 끌어당김), 초근접 공격 성공 시 체력 회복(lvl × 0.5% max HP), 초근접 스킬 데미지 고유 배율의 80% 적용(레벨당 +28% 수준), 피격 시 금강 충격파(lvl × 80 피해) 방출, 받는 피해 lvl × 6% 추가 감소' },
};
